...
\hypersetup{
  pdftitle={Rowan and Yeonwoo's Customizing plots},
  colorlinks=true,
  linkcolor={blue},
  filecolor={Maroon},
  citecolor={Blue},
...
\title{Rowan and Yeonwoo's Customizing plots}
\author{}
\date{}
...
\includegraphics{W2Customizingplots_files/figure-pdf/unnamed-chunk-1-1.pdf}
...
\#1.1: It looks like there are atleast two different congregations or
areas where points are concentrated.
...
\includegraphics{W2Customizingplots_files/figure-pdf/unnamed-chunk-2-1.pdf}
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{ggplot}\NormalTok{(}\AttributeTok{data =}\NormalTok{ penguins, }\AttributeTok{mapping=}\FunctionTok{aes}\NormalTok{(}\AttributeTok{x =}\NormalTok{ bill\_length\_mm, }\AttributeTok{y =}\NormalTok{ bill\_depth\_mm, }\AttributeTok{color=}\NormalTok{species)) }\SpecialCharTok{+}
  \FunctionTok{geom\_point}\NormalTok{() }\SpecialCharTok{+}
  \FunctionTok{scale\_color\_manual}\NormalTok{(}\AttributeTok{values=}\FunctionTok{c}\NormalTok{(}\StringTok{"black"}\NormalTok{,}\StringTok{"blue"}\NormalTok{,}\StringTok{"pink"}\NormalTok{))}
\end{Highlighting}
\end{Shaded}
...
\includegraphics{W2Customizingplots_files/figure-pdf/unnamed-chunk-3-1.pdf}
...
\includegraphics{W2Customizingplots_files/figure-pdf/unnamed-chunk-4-1.pdf}
...
\includegraphics{W2Customizingplots_files/figure-pdf/unnamed-chunk-5-1.pdf}
...
\includegraphics{W2Customizingplots_files/figure-pdf/unnamed-chunk-6-1.pdf}
...
\includegraphics{W2Customizingplots_files/figure-pdf/unnamed-chunk-7-1.pdf}
...
\includegraphics{W2Customizingplots_files/figure-pdf/unnamed-chunk-8-1.pdf}
...
\includegraphics{W2Customizingplots_files/figure-pdf/unnamed-chunk-9-1.pdf}
...
\includegraphics{W2Customizingplots_files/figure-pdf/unnamed-chunk-10-1.pdf}
...
\includegraphics{W2Customizingplots_files/figure-pdf/unnamed-chunk-11-1.pdf}
...
\includegraphics{W2Customizingplots_files/figure-pdf/unnamed-chunk-12-1.pdf}
...
\includegraphics{W2Customizingplots_files/figure-pdf/unnamed-chunk-13-1.pdf}
...
\includegraphics{W2Customizingplots_files/figure-pdf/unnamed-chunk-14-1.pdf}
...
\includegraphics{W2Customizingplots_files/figure-pdf/unnamed-chunk-15-1.pdf}
...
\includegraphics{W2Customizingplots_files/figure-pdf/unnamed-chunk-16-1.pdf}
...
\includegraphics{W2Customizingplots_files/figure-pdf/unnamed-chunk-18-1.pdf}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{?}\FunctionTok{element\_text}\NormalTok{()}
\FunctionTok{ggplot}\NormalTok{(}\AttributeTok{data =}\NormalTok{ penguins, }\FunctionTok{aes}\NormalTok{(}\AttributeTok{x =}\NormalTok{ bill\_length\_mm, }\AttributeTok{y =}\NormalTok{ bill\_depth\_mm)) }\SpecialCharTok{+}
  \FunctionTok{geom\_point}\NormalTok{(}\FunctionTok{aes}\NormalTok{(}\AttributeTok{fill =}\NormalTok{ species,}
                 \AttributeTok{shape =}\NormalTok{ species),}
             \AttributeTok{size =} \FloatTok{2.5}\NormalTok{) }\SpecialCharTok{+}
...
\includegraphics{W2Customizingplots_files/figure-pdf/unnamed-chunk-19-1.pdf}
...
\includegraphics{W2Customizingplots_files/figure-pdf/unnamed-chunk-20-1.pdf}
...
\includegraphics{W2Customizingplots_files/figure-pdf/unnamed-chunk-21-1.pdf}
...
--Our audience will be a class of beginner scientists. This means that
they have a basic understanding of graphs including data, averages, and
data error. This means our graph is a little bit less simple and
includes error bars.
...
--We want to fix the labels including the legend, giving it a title (and
centering it), and making sure the x and y axis titles don't include
underscores. Then we want to change our colors to make them more
intuitive with species names, which are colors, so they match! This
included, eventhough the white abalone species was white making it
instead a sky blue so that it was easily seen. Then we also gave it a
theme to make it look better.
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{aba\_lan}\OtherTok{\textless{}{-}}\FunctionTok{read.csv}\NormalTok{(}\StringTok{"abalone\_landings.csv"}\NormalTok{)}
\FunctionTok{ggplot}\NormalTok{(}\AttributeTok{data =}\NormalTok{ aba\_lan, }\AttributeTok{mapping =} \FunctionTok{aes}\NormalTok{(}\AttributeTok{x =}\NormalTok{ Year, }\AttributeTok{y =}\NormalTok{ Abalone\_Landings\_lbs, }\AttributeTok{color =}\NormalTok{ Abalone\_Species)) }\SpecialCharTok{+}
  \FunctionTok{geom\_point}\NormalTok{(}\AttributeTok{size=}\FloatTok{2.5}\NormalTok{) }\SpecialCharTok{+}
  \FunctionTok{geom\_smooth}\NormalTok{() }\SpecialCharTok{+}
  \FunctionTok{scale\_color\_manual}\NormalTok{(}\AttributeTok{values =} \FunctionTok{c}\NormalTok{(}\StringTok{"black"}\NormalTok{, }\StringTok{"forestgreen"}\NormalTok{, }\StringTok{"orchid"}\NormalTok{, }\StringTok{"maroon"}\NormalTok{, }\StringTok{"skyblue"}\NormalTok{))}\SpecialCharTok{+}
  \FunctionTok{labs}\NormalTok{(}\AttributeTok{y=}\StringTok{"Abalone harvest (lbs)"}\NormalTok{,}
       \AttributeTok{fill=}\StringTok{"Abalone Species"}\NormalTok{,}
       \AttributeTok{color=}\StringTok{"Abalone Species"}\NormalTok{,}
       \AttributeTok{shape=}\StringTok{"Abalone Species"}\NormalTok{,}
       \AttributeTok{title=}\StringTok{"Abalone harvest from 1973 to 1997"}\NormalTok{)}\SpecialCharTok{+}
...
\includegraphics{W2Customizingplots_files/figure-pdf/unnamed-chunk-22-1.pdf}
...
---We hope the audience will see the graph and understand that abalone
populations have declined significantly since 1973 and that we can see
this in the amount harvested by fisherman. We hope our audience can
easily distinguish between the colors and that the graph is intuitive
for an audience with a beginning experience in science.
...
\url{https://docs.google.com/presentation/d/1wAGmbArAW2YKmufrBbzCQ3BcDdwDknzgoRHYEmFXJko/edit?usp=sharing}
